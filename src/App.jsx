...
// så på touch gir det ingen effekt — vi dropper det der (sparer batteri/CPU)
// og beholder de ambiente lysstrålene, som ser bra ut uansett.
...
export default function App() {
  ...
  const coarse = useCoarseOrNarrow()
  const showDots = !reduce && !coarse
  ...
  return (
    ...
    <MotionConfig reducedMotion="user">
      ...
      {/* Interaktivt prikk-felt: fast bakgrunnslag bak strålene. Av ved redusert
          bevegelse og på touch/smale skjermer (ingen markør = ingen effekt). */}
      {showDots && (
